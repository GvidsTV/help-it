...
// High-intent pages (only 2 created so far)
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* High-intent pages - ONLY 2 WORKING */}
        <Route path="/help/cant-log-into-gmail" element={<CantLoginGmail />} />
        <Route path="/help/iphone-storage-full" element={<IPhoneStorageFull />} />
        
        {/* Remaining high-intent pages redirect to contact until we create them */}
        <Route path="/help/forgot-password" element={<ContactPage />} />
        <Route path="/help/wifi-wont-connect" element={<ContactPage />} />
        <Route path="/help/slow-computer-fix" element={<ContactPage />} />
        <Route path="/help/printer-offline" element={<ContactPage />} />
        <Route path="/help/zoom-camera-not-working" element={<ContactPage />} />
        <Route path="/help/phone-wont-charge" element={<ContactPage />} />
        <Route path="/help/email-hacked" element={<ContactPage />} />
        <Route path="/help/cant-download-apps" element={<ContactPage />} />
      </Routes>
    </BrowserRouter>
  );
}
