# 1. Install the missing Anthropic library
Write-Host "--- Installing Anthropic SDK ---" -ForegroundColor Cyan
npm install @anthropic-ai/sdk

# 2. Update netlify/functions/chat.js
Write-Host "--- Updating Backend Logic ---" -ForegroundColor Cyan
$chatJS = @'
...
# 3. Update src/components/ChatWidget.jsx
Write-Host "--- Updating Chat Widget ---" -ForegroundColor Cyan
$widgetJSX = @'
...
git add .
git commit -m "feat: complete sync of memory logic and backend dependencies"
git push origin master

Write-Host "--- Done! Check Netlify for the new build. ---" -ForegroundColor Green